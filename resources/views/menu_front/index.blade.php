                ...
                <div class="card card-custom" style="width: 100%">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--end::Dropdown-->
                            <!--begin::Button-->
                            @can('creation-menu-front')
                                <a href="{{ route('creermenufront') }}" class="btn btn-sm btn-primary font-weight-bolder">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                            ...
                            @foreach ($data as $key => $menu)
                                <tr>
                                    <td>{{ $menu->id_menu_front  }}</td>
                                    <td>{{ $menu->nenu_front }}</td>
                                    <td align="center">
                                        @can('modification-menu-front')
                                            <a href="{{ route('modifiermenufront',\App\Helpers\Crypt::UrlCrypt($menu->id_menu_front)) }}" class="btn btn-warning btn-xs btn-clean btn-icon"
