...
@section('content')
    ...
    @php($titre='Liste des menus front')
    @php($soustitre='Ajouter un menu')
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <!--end::Notice-->
                ...
                <div class="card card-custom" style="width: 100%">
                    ...
                    {!! Form::open(array('route' => 'creermenufront','method'=>'POST')) !!}
                        @csrf
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    {!! Form::text('nenu_front', null, array('placeholder' => 'Libellé du module','class' => 'form-control')) !!}

                                    <span class="form-text text-muted">  </span>
                                </div>
                                <div class="col-lg-6">
                                    <label>Priorite:</label>
                                    {!! Form::number('priorite_menu_front', null, array('placeholder' => 'Libellé du module','class' => 'form-control')) !!}
