...
@php($titre='Liste des newsletters')
            ...
            <div class="card card-custom" style="width: 100%">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                        ...
                        <tr>
                            <td>{{ $newsletter->id_new  }}</td>
                            <td>{{ $newsletter->email_new }} </td>
                            <td>{{ Carbon::parse($newsletter->created_at)->format('d/m/Y') }} </td>
                            <td>
                                <?php if($newsletter->date_desabonnement == null){
                                 echo " ";
                                }else{
                                    echo Carbon::parse($newsletter->date_desabonnement)->format('d/m/Y');
                                } ?>
                           </td>
                             <td>   <?php if($newsletter->flag_new == 1){ ?>
