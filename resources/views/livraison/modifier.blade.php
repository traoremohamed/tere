...
@section('content')
    ...
    @php($soustitre='Modifier un livrable')
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form action="{{ route('modifier-livrable',\App\Helpers\Crypt::UrlCrypt($type->id)) }}" method="POST">
                                @csrf
                        <div class="card-body" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input placeholder="Entrez la date" type='date' name="datelivraison" class="form-control mb-1" value="{{$type->datelivraison}}">
                                    <span class="form-text text-muted">  </span>
                                </div>
                            </div>
                        </div>
