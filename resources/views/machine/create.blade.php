...
@section('content')
    ...
    @php($soustitre='Ajouter un matériel')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                        {!! Form::open(array('route' => 'store-machine','method'=>'POST')) !!}
                        ...
                        <div class="card-body" >
                            <div class="form-group row ">
                                ...
                                <div id="dynamicCheck">
                                    <input type="button" class="btn btn-warning" value="Ajouter un matériel" onclick="createNewElement();">
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>Désignation matériel</label>
