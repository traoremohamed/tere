            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{ route('sousmenus.update',$sousmenus->id_sousmenu) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" name="menu" value="{{ $sousmenus->sousmenu }}" class="form-control" placeholder="Name">

                                            <span class="form-text text-muted">  </span>
                                        </div>
                                        <div class="col-lg-6">
                                            <label>Libelle</label>
                                            <input type="text" name="libelle" value="{{ $sousmenus->libelle }}" class="form-control" placeholder="Name">
                                            <span class="form-text text-muted">  </span>
                                        </div>
