            ...
            <div class="card card-custom" style="width: 100%">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label>Titre:</label>
                            {!! Form::text('titre_produit', null, array('placeholder' => 'Titre produit','class' => 'form-control')) !!}

                            <span class="form-text text-muted">  </span>
                        </div>
                        <div class="col-lg-6">
                            <label>Description:</label>
                            <textarea class="form-control" id="description_produit" name="description_produit" rows="6"></textarea>
