...
@php($soustitre='Ajouter une page')
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom" style="width: 100%">
                ...
                {!! Form::open(array('route' => 'creergestiondepage','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" placeholder="Nom technique" name="nom_tech_gest_page" required="required" />

                        </div>

                        <div class="col-lg-6">
                            <label>Nom public :</label>
                            <input type="text" class="form-control" placeholder="Nom public" name="nom_pub_gest_page" required="required" />

                        </div>

                        <div class="col-lg-6">
                            <label>Ordre:</label>
                            <input type="number" class="form-control" placeholder="Ordre" name="ordre_gest_page"  required="required"/>
                        ...
                        <div class="col-lg-12 col-md-9 col-sm-12">
                            <textarea class="summernote"  name="descrp_gest_page" rows="6"></textarea>
