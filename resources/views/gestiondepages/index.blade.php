            ...
            <div class="card card-custom" style="width: 100%">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                        ...
                        <tbody>
                        @foreach ($gestiondepages as $key => $gestiondepage)
                        <tr>
                            <td>{{ $gestiondepage->id_gest_page }}</td>
                            ...
                            <td align="center">
                                ...
                                <?php if($gestiondepage->flag_gest_page == 1){ ?>
                                    ...
                                    <label class="label label-lg label-warning label-inline"><a href="{{ route('modifiergestiondepage',\App\Helpers\Crypt::UrlCrypt($gestiondepage->id_gest_page)) }}"> Desactiver </a></label>
