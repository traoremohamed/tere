...
@section('content')
    ...
    @php($soustitre='Modifier une projection')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                        <form action="{{ route('modifier-projection',\App\Helpers\Crypt::UrlCrypt($type->id)) }}" method="POST">
                                @csrf
                        <div class="card-body" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input placeholder="Entrez la date" type='date' name="dateprojection" class="form-control mb-1" value="{{$type->dateprojection}}">
                                    <span class="form-text text-muted">  </span>
                                </div>
