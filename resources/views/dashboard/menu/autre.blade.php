        ...
        <div class="col-xl-4">
            ...
            <div class="card card-custom bgi-no-repeat card-stretch gutter-b"
                ...
                <div class="card-body">
                    ...
                    <span class="font-weight-bold text-muted font-size-sm">Nombre total de nouvelle demande</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 29-->
        ...
        <div class="col-xl-4">
            ...
            <div class="card card-custom bg-danger card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span
                        class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block"> </span>
                    <span class="font-weight-bold text-white font-size-sm">Nombre total des newsletters</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 31-->
