<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">Projet en cours de réalisation</span>
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Etats des Livraisons</span>
        </h3>
        ...
        <div class="table-responsive">
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_3">
                ...
                <tr class="text-left text-uppercase">
                    ...
                    <th class="px-0" style="width: 50px">Clients</th>
                    <th style="min-width: 120px"></th>
                    <th style="min-width: 120px">Titre du projet</th>
                    <th class="text-info" style="min-width: 150px">Date de Fin</th>
                ...
                <tr>
                    ...
                    <td class="pl-0">
                        <a href="#"
                           class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Lia
                            Romaric </a>
                        <span class="text-muted font-weight-bold text-muted d-block"></span>
                    </td>
                    <td>
                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">Titre</span>
                        <span class="text-muted font-weight-bold">Projet</span>
                    </td>
                    <td>
                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg"></span>
                        <span class="text-muted font-weight-bold">Juin-07-2020</span>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="pl-0">
                        <a href="#"
                           class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">AWA
                            SOULEYMANE </a>
                        <span class="text-muted font-weight-bold text-muted d-block"></span>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="pl-0">
                        <a href="#"
                           class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Mamadou
                            Binate</a>
                        <span class="text-muted font-weight-bold text-muted d-block"></span>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="pl-0">
                        <a href="#"
                           class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">SIAKA
                            Ouattara</a>
                        <span class="text-muted font-weight-bold text-muted d-block"></span>
                    </td>
                    <td>
