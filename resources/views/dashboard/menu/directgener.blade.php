    ...
    <div class="row">
        ...
        <path
            ...
            fill="#000000"/>
                    ...
                    <span
                        class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{ count($dataSite) }} </span>
                    <span class="font-weight-bold text-white font-size-sm">Nombre total de site</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 30-->
        ...
        <div class="col-xl-4">
            ...
            <div class="card card-custom bg-danger card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span
                        class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{ count($dataBien) }} </span>
                    <span class="font-weight-bold text-white font-size-sm">Nombre total de biens</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 31-->
