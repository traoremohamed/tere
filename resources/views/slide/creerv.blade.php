    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom" style="width: 100%">
                ...
                {!! Form::open(array('route' => 'creerslidesv','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-12">
                            <label>Media:</label>
                            <input type="text" class="form-control" placeholder="ajouter un  fichier" name="slide"  />
