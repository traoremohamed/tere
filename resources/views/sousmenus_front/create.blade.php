...
@section('content')
    ...
    @php($soustitre='Ajouter un sous menu')
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <!--end::Notice-->
                ...
                <div class="card card-custom" style="width: 100%">
                  ...
                  {!! Form::open(array('route' => 'creermenufronthaut','method'=>'POST')) !!}

                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <label>Sous Menu</label>
                               {!! Form::text('sous_menu_front', null, array('placeholder' => 'Sous menu','class' => 'form-control')) !!}
                               <span class="form-text text-muted">  </span>
                            </div>
                            <div class="col-lg-6">
                                <label>Libelle</label>
                                  {!! Form::text('libelle_sous_menu_front', null, array('placeholder' => 'libelle','class' => 'form-control')) !!}
                               <span class="form-text text-muted">  </span>
                            </div>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-lg-6">
                                ...
                                {!! Form::number('priorite_sous_menu_front', null, array('placeholder' => 'Priorite','class' => 'form-control')) !!}
                                <span class="form-text text-muted">  </span>
                            </div>

                         <div class="col-lg-6">
                             <label>Menu front</label>
                                    <select class="form-control form-control-sm" name="menu_front_id_menu_front" id="kt_select2_2" required="required">
                                      <?php echo $menus; ?>
                                    </select>
                                </div>
