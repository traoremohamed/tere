                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <?php if($categorieproduit->flag_cat_prod == 1){ ?>
                                    ...
                                    <label class="label label-lg label-warning label-inline"><a href="{{ route('modifiercategorieproduit',\App\Helpers\Crypt::UrlCrypt($categorieproduit->id_cat_prod)) }}"> Desactiver </a></label>
