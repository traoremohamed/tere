...
@php($soustitre='Ajouter un banner')
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom" style="width: 100%">
                ...
                {!! Form::open(array('route' => 'creerbanner','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label>Titre banner :</label>
                            {!! Form::text('titre_banner', null, array('placeholder' => 'Titre banner','class' => 'form-control','required' => 'required')) !!}
