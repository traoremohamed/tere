...
@section('content')
    ...
    @php($soustitre='Modifier un intervenant')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                        <form action="{{ route('modifier-intervenant',\App\Helpers\Crypt::UrlCrypt($type->id)) }}" method="POST">
                                @csrf
                        <div class="card-body" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <label>Nombre</label>
                                    <input placeholder="Entrez le nombre" type=text name="nombre" class="form-control mb-1" value="{{$type->nombre}}">
                                    <span class="form-text text-muted">  </span>
                                </div>
