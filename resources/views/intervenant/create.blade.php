...
@section('content')
    ...
    @php($titre='Liste des intervenants')
    @php($soustitre='Ajouter un intervenant')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                        {!! Form::open(array('route' => 'store-intervenant','method'=>'POST')) !!}
                        ...
                        <div class="card-body" >
                            <div class="form-group row ">
                                ...
                                <div id="dynamicCheck">
                                    <input type="button" class="btn btn-warning" value="Ajouter un intervenant" onclick="createNewElement();">
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>Désignation intervenant</label>
                                    <input placeholder="Entrez la désignation" type=text name="designation[]" class="form-control mb-1">
                                    <span class="form-text text-muted">  </span>
                                </div>
                                <div class="col-lg-6">
                                    <label>Nombre</label>
                                    <input placeholder="Entrez le nombre" type=text name="nombre[]" class="form-control mb-1">
                                    <span class="form-text text-muted">  </span>
                                </div>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-lg-6">
                                    <a class="btn btn-sm btn-secondary" href="{{ route('list-intervenant') }}"> Retour</a>
                                </div>
...
function createNewElement(){
    ...
    txtNewInputBox1.innerHTML="<div><input placeholder='Entrez le nombre' type=text name='nombre[]' class='form-control mb-1'><span class='form-text text-muted'></span></div>";
