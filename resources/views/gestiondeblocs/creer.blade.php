    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom" style="width: 100%">
                ...
                {!! Form::open(array('route' => 'creergestiondebloc','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" placeholder="Nom technique" name="nom_tech_gest_bloc" required="required"  />

                        </div>

                        <div class="col-lg-4">
                            <label>Nom public :</label>
                            <input type="text" class="form-control" placeholder="Nom public" name="nom_pub_gest_bloc"  required="required" />

                        </div>

                        <div class="col-lg-6">
                            <label>Ordre:</label>
                            <input type="number" class="form-control" placeholder="Ordre" name="ordre_gest_bloc"  required="required" />

                        </div>

                        <div class="col-lg-6">
                            <label>Bloc parent:</label>
                            <input type="text" class="form-control" placeholder="Bloc parent" name="bloc_parent"  />
                        ...
                        <div class="col-lg-12 col-md-9 col-sm-12">
                            <textarea class="summernote"  name="descrp_gest_bloc" rows="6"></textarea>
