            ...
            <div class="card card-custom" style="width: 100%">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                        ...
                        <tbody>
                        @foreach ($categorieactivites as $key => $categorieactivite)
                        <tr>
                            <td>{{ $categorieactivite->id_categ }}</td>
                            ...
                            <td align="center">
                                ...
                                <?php if($categorieactivite->flag_categ == 1){ ?>
                                    ...
                                    <label class="label label-lg label-warning label-inline"><a href="{{ route('modifiercategorieactivite',\App\Helpers\Crypt::UrlCrypt($categorieactivite->id_categ)) }}"> Desactiver </a></label>
