...
@php($soustitre='Modifier une categorie')
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom" style="width: 100%">
                        ...
                        <!--begin::Button-->
                         @can('active-desative-categorie_acti')
                                                       ...
                                                       <?php }else{ ?>
                                                           ...
                                                           <label class="label label-lg label-success label-inline"><a href="{{ route('activecategorieactivite',\App\Helpers\Crypt::UrlCrypt($categorieactivite->id_categ)) }}"> Active </a></label>
                ...
                <form  action="{{ route('modifiercategorieactivite',\App\Helpers\Crypt::UrlCrypt($id))}}" method="post"  enctype="multipart/form-data">
                    @csrf
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" placeholder="Libelle categorie" name="lib_categ"  value="{{$categorieactivite->lib_categ}}" />
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-lg-6">
                            <a class="btn btn-sm btn-secondary" href="{{ route('categorieactivite') }}"> Retour</a>
                        </div>
