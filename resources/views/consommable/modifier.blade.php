...
@section('content')
    ...
    @php($titre='Liste des consommables')
    @php($soustitre='Modifier un consommable')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                        <form action="{{ route('modifier-consommable',\App\Helpers\Crypt::UrlCrypt($type->id)) }}" method="POST">
                                @csrf
                        ...
                        <div class="card-body" >
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    <label>Désignation consommable</label>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input placeholder="Entrez la quantité" type=text name="quantite" class="form-control mb-1" value="{{$type->quantite}}">
                                    <span class="form-text text-muted">  </span>
                                </div>
                                <div class="col-lg-4">
                                    <label>Unité</label>
                                    <input placeholder="Entrez l'unité" type=text name="unite" class="form-control mb-1" value="{{$type->unite}}">
                                    <span class="form-text text-muted">  </span>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-lg-6">
                                    <a class="btn btn-sm btn-secondary" href="{{ route('list-consommable') }}"> Retour</a>
                                </div>
