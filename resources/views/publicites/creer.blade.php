...
@php($soustitre='Ajouter publicite')
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom" style="width: 100%">
                ...
                {!! Form::open(array('route' => 'creerpublicites','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" placeholder="Libelle de la publicite" name="lib_pub"  />
                        ...
                        <div class="col-lg-12">
                            ...
                            <textarea class="summernote" id="descr_pub" name="descr_pub" rows="6"></textarea>
